                        ...
                        success: function (data) {
                            ...
                            if (data == '0') {
								...
								for (var i = 0; i < jsonData.length; i++) {
                                    str += '<tr><td><b>Họ và tên:</b> '+ jsonData[i].vanbang_hoten +'</td><td><b>Ngày sinh:</b> ' + jsonData[i].vanbang_ngaysinh + '</td><td><b>Nơi sinh:</b> ' + jsonData[i].vanbang_noisinh + '</td><td><b>Giới tính:</b> ' + jsonData[i].vanbang_gioitinh + '</td><td><b>Dân tộc:</b> ' + jsonData[i].vanbang_dantoc + '</td></tr><tr><td><b>Ngành đào tạo:</b> ' + jsonData[i].vanbang_nganhdaotao + '</td><td><b>Khóa:</b> ' + jsonData[i].vanbang_machungchi + '</td><td><b>Hình thức ĐT:</b> ' + jsonData[i].vanbang_htdaotao + '</td><td><b>Năm TN:</b> ' + jsonData[i].vanbang_namtotnghiep + '</td><td><b>Xếp loại:</b> ' + jsonData[i].vanbang_xeploai + '</td></tr><tr><td><b>Số Quyết định:</b> ' + jsonData[i].vanbang_sototnghiep + '</td><td><b>Ngày Quyết định:</b> ' + jsonData[i].vanbang_ngaytotnghiep + '</td><td><b>Số hiệu VBCC:</b> ' + jsonData[i].vanbang_machungchi + '</td><td><b>Số vào sổ:</b> ' + jsonData[i].vanbang_chungchiso + '</td><td></td></tr>';
                                }
								str += '</table>';
