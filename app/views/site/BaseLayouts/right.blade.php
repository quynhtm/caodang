		...
		<div class="donvi-khoa-trungtam">
			...
			<div class="navigation">
				<ul>
					...
					<li class="dot"><a href="">Phòng ban</a>
						<ul>
							<li><a href="">Phòng đào tạo</a></li>
							<li><a href="">Phòng hành chính</a></li>
						</ul>
					</li>
					<li class="dot"><a href="">Trung tâm</a>
						<ul>
							<li><a href="">Trung tâm tiếng anh</a></li>
						</ul>
